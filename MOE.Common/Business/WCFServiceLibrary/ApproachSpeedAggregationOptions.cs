    ...
    public class ApproachSpeedAggregationOptions : ApproachAggregationMetricOptions
    {
        ...
        protected override int GetAverageByPhaseNumber(Models.ATSPM_Signals atspmSignals, int phaseNumber)
        {
            var speedAggregationBySignal =
                new SpeedAggregationBySignal(this, atspmSignals);
        ...
        {
            var speedAggregationBySignal =
                new SpeedAggregationBySignal(this, atspmSignals, direction);
            return speedAggregationBySignal.Average;
        }
        ...
        {
            var speedAggregationBySignal = new SpeedAggregationBySignal(this, atspmSignals);
        ...
        {
            var speedAggregationBySignal =
                new SpeedAggregationBySignal(this, atspmSignals, directionType);
            return speedAggregationBySignal.BinsContainers;
        }
        ...
        {
            var speedAggregationBySignal =
                new SpeedAggregationBySignal(this, atspmSignals, phaseNumber);
            return speedAggregationBySignal.BinsContainers;
        }
